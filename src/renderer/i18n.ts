...
const translations = {
  ...
  'virt.scan': { en: 'Scan Files', zh: '掃描檔案' },
  'virt.scanning': { en: 'Scanning...', zh: '掃描中...' },
  'virt.scanPointers': { en: 'Scan .refile Pointers', zh: '掃描 .refile 指標' },
  'virt.pushToCloud': { en: 'Push to Cloud', zh: '推送至雲端' },
  'virt.restore': { en: 'Restore', zh: '還原' },
  'virt.pushing': { en: 'Pushing...', zh: '推送中...' },
  'virt.pulling': { en: 'Pulling...', zh: '拉回中...' },
  ...
  'virt.mode.push': { en: 'Push (Upload)', zh: '推送（上傳）' },
  'virt.mode.pull': { en: 'Pull (Restore)', zh: '拉回（還原）' },
  ...
  'virt.confirm.push': { en: 'Confirm Push', zh: '確認推送' },
  'virt.confirm.pushDesc': {
    en: 'Upload {count} files ({size}) to cloud and replace with .refile pointers? Original files will be deleted.',
    zh: '將 {count} 個檔案（{size}）上傳至雲端並替換為 .refile 指標？原始檔案將被刪除。',
  },
  'virt.confirm.pull': { en: 'Confirm Restore', zh: '確認還原' },
  'virt.confirm.pullDesc': {
    en: 'Download and restore {count} files ({size}) from cloud?',
    zh: '從雲端下載並還原 {count} 個檔案（{size}）？',
  },
  'virt.result.pushed': { en: 'Pushed successfully', zh: '推送成功' },
  'virt.result.pulled': { en: 'Restored successfully', zh: '還原成功' },
  'virt.result.failed': { en: 'Errors', zh: '錯誤' },
  'virt.status.virtualized': { en: 'Virtualized files', zh: '已虛擬化檔案' },
  'virt.status.saved': { en: 'Space saved', zh: '節省空間' },
  'virt.config.title': { en: 'Backend Config', zh: '後端設定' },
