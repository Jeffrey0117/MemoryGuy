...
const translations = {
  ...
  // Disk Watchdog
  'tab.watchdog': { en: 'Disk Alerts', zh: '磁碟警報' },
  'watchdog.title': { en: 'Disk Space Watchdog', zh: '磁碟空間看門狗' },
  'watchdog.desc': {
    en: 'Monitors free disk space and sends a Telegram alert when a drive runs low — so you never get surprised by a full disk again.',
    zh: '監控磁碟剩餘空間,某顆碟快滿時直接發 Telegram 通知你 — 以後不會再被塞爆突襲。',
  },
  'watchdog.enable': { en: 'Enable watchdog', zh: '啟用看門狗' },
  'watchdog.telegramToken': { en: 'Telegram Bot Token', zh: 'Telegram Bot Token' },
  'watchdog.telegramTokenHint': { en: 'From @BotFather — reuse your existing bot', zh: '來自 @BotFather — 可重用你現有的 bot' },
  'watchdog.telegramChatId': { en: 'Telegram Chat ID', zh: 'Telegram Chat ID' },
  'watchdog.telegramChatIdHint': { en: 'Your admin chat id — where alerts are sent', zh: '你的 admin chat id — 警報送到這' },
  'watchdog.warnGb': { en: 'Warn below (GB free)', zh: '黃燈門檻（剩餘 GB）' },
  'watchdog.urgentGb': { en: 'Urgent below (GB free)', zh: '紅燈門檻（剩餘 GB）' },
  'watchdog.intervalSec': { en: 'Check interval (sec)', zh: '檢查間隔（秒）' },
  'watchdog.reNotifyMin': { en: 'Re-notify every (min)', zh: '重複提醒間隔（分）' },
  'watchdog.save': { en: 'Save', zh: '儲存' },
  'watchdog.saved': { en: 'Saved', zh: '已儲存' },
  'watchdog.test': { en: 'Send Test Alert', zh: '發送測試通知' },
  'watchdog.testing': { en: 'Sending...', zh: '發送中...' },
  'watchdog.testOk': { en: 'Test sent — check your Telegram', zh: '測試已送出 — 看一下你的 Telegram' },
  'watchdog.testFail': { en: 'Failed', zh: '失敗' },
  'watchdog.needConfig': { en: 'Enter your Telegram token and chat id first', zh: '請先填入 Telegram token 和 chat id' },
  'watchdog.drives': { en: 'Drives', zh: '磁碟現況' },
  'watchdog.refresh': { en: 'Refresh', zh: '重新整理' },
  'watchdog.free': { en: 'free', zh: '剩餘' },
  'watchdog.statusOk': { en: 'OK', zh: '正常' },
  'watchdog.statusWarn': { en: 'Low', zh: '偏低' },
  'watchdog.statusUrgent': { en: 'Critical', zh: '緊急' },
  'watchdog.statusUnknown': { en: 'Unknown', zh: '無法讀取' },
  'watchdog.noDrives': { en: 'No drives detected yet', zh: '尚未偵測到磁碟' },
